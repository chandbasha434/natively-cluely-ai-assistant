...
interface ElectronAPI {
  ...
  getStoredCredentials: () => Promise<{ 
    ...
    sttProvider: string;
    geminiPreferredModel: string | null;
    groqPreferredModel: string | null;
    openaiPreferredModel: string | null;
    claudePreferredModel: string | null;
    nvidiaPreferredModel: string | null;
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  testLlmConnection: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'nvidia', apiKey: string) => ipcRenderer.invoke("test-llm-connection", provider, apiKey),
  ...
  fetchProviderModels: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'nvidia', apiKey: string) => ipcRenderer.invoke('fetch-provider-models', provider, apiKey),
  setProviderPreferredModel: (provider: 'gemini' | 'groq' | 'openai' | 'claude' | 'nvidia', modelId: string) => ipcRenderer.invoke('set-provider-preferred-model', provider, modelId),
